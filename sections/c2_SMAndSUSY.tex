...
\selectfont
\begin{centering}
\caption{\label{tab:c24ei} The Elementary Interactions}
\hspace*{-4ex}
\begin{tabular}{|c|c|c|c|c|}
\hline
Interaction & Gravity & Weak & Electromagnetic & Strong \\
\hline
abc         & Mass-Energy & Flavor & Electric charge & Color charge \\
\hline
def         & All & Quark, Lepton & \specialcell{Quark, Charged lepton\\(Electron, Muon and Tau)} & Quarks, Gluons \\
\hline
