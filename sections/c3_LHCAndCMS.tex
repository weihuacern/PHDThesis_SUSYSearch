...
If the smallest one is a $d_{ij}$, we combine the two pixels i and j. Then we recalculate the special distance as the input of next iteration.
If the smallest one is a $d_{iB}$, we remove pixel i and call it a jet.
