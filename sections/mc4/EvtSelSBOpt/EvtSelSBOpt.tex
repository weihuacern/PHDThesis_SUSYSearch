The analysis is designed for maximum sensitivity to the SUSY simplified model
...
and large \MET.
%The search will also be interpreted in the SMS T5ttcc topology as soon as the signal MC becomes available.
The T2tt, T5ttcc and T1tttt final states differ in the number of jets, b-tagged jets and top quarks produced. 
%These two simplified models may have different mass splitting between 
%the gluino or top squark and the LSP. 
...
%We also considered a model in which the dark matter candidate particles are produced in association with \ttbar{}, as shown at the bottom of Fig.~\ref{Fig:signal_diagrams}.
