...
Table~\ref{tab:QCDpred84_1}, Table~\ref{tab:QCDpred84_2} and Table~\ref{tab:QCDpred84_3}, which includes statistical and systematic uncertainties.
...
\selectfont
\begin{centering}
\caption{\label{tab:QCDpred84_3} Predicted QCD backgrounds corresponding to
