...
Due to the requirement of the present of reconstructed top candidate, the processes associated
with top quark are expected to have higher selection efficiency than the rest.  The
...
The lost lepton and hadronic tau background used data driven method, which
takes into account the leptonically-decayed $W$ and $Z$ component of these
backgrounds. The $Z$ invisible background method only used $DY$ MC to derive
its scale factors. So only the hadronically-decayed $W$ and $Z$,
$Z\rightarrow\nu\nu$ component of these rare backgrounds remain. To remove the
overlap between the prediction and the lost lepton and hadronic tau background
prediction, a veto on the generator level leptonically decay $W$ and $Z$ is
applied in the final yeild.
...
The list of MC samples for \ttbarZ and backgrounds are listed in
