...
Due to the requirement that at least one reconstructed top quark candidate be present, the associated
...
The lost lepton and hadronic tau background used a data driven method, which therefore automatically takes into account the leptonically decaying $W$ and $Z$ components of these
...
The list of MC samples for \ttbarZ and other rare backgrounds are listed in
